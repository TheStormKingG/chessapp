...
export function Summary({ review, onStart }: { review: Review; onStart: () => void }) {
  ...
  return (
    <div className="mx-auto w-full max-w-xl p-4">
      ...
      <section className="mt-4 n-raised rounded-card bg-surface-raised p-4" aria-labelledby="rv-acc">
      ...
      <section className="mt-4" aria-labelledby="rv-counts">
        ...
        {showDefs && (
          <dl className="mt-2 n-raised rounded-card bg-surface-raised p-4">
            {LABEL_ORDER.map((l) => (
